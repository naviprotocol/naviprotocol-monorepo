...
const methodology = {
  Fees: "Gross yield earned in the window by NAVI's High Yield vaults on Sui, before any fee is taken. The yield comes from the NAVI lending markets the vaults supply into.",
...
const adapter: SimpleAdapter = {
  ...
  breakdownMethodology: {
    Fees: {
      [METRIC.ASSETS_YIELDS]: "Gross yield earned by the High Yield vaults from the NAVI lending markets they supply into",
    },
    Revenue: {
      [METRIC.MANAGEMENT_FEES]: "Management fee NAVI charges on assets held in the High Yield vaults",
      [METRIC.PERFORMANCE_FEES]: "Performance fee NAVI charges on the yield the High Yield vaults earn",
    },
    ProtocolRevenue: {
    ...
    SupplySideRevenue: {
      [METRIC.ASSETS_YIELDS]: "Yield paid out to High Yield vault depositors after fees",
    },
  },
};
