...
- <a href="/wallet-client/client#private-key-wallet">Private Key Wallet</a> - Create a wallet client using a private key to perform all blockchain operations
- <a href="/wallet-client/client#watch-only-wallet">Watch-Only Wallet</a> - Use a watch-only wallet to view wallet information but cannot execute transactions
- <a href="wallet-client/client#browser-extension-wallet">Browser Extension Wallet</a> - Create an adapter for browser environment (PC, Mobile) extension wallet
