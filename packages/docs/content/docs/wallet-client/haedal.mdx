...
The package ID of the Haedal contract, defaults to `0x19e6ea7f5ced4f090e20da794cc80349a03e638940ddb95155a4e301f5f4967c`.
...
<Callout>
  This method is used for building complex transactions that combine multiple operations. For simple
  staking operations, use the `stake` method instead.
</Callout>
...
<Callout>
  This method is used for building complex transactions that combine multiple operations. For simple
  unstaking operations, use the `unstake` method instead.
</Callout>
