...
Get the current borrowing fee rate. See [documentation](/typedoc/variables/_naviprotocol_lending.getBorrowFee.html) for details.
...
<Callout>If you don't want to construct the transaction yourself, you can refer to the <a href="/wallet-client/lending#deposit">deposit feature of @naviprotocol/wallet-client</a></Callout>
...
<Callout>If you don't want to construct the transaction yourself, you can refer to the <a href="/wallet-client/lending#withdraw">withdraw feature of @naviprotocol/wallet-client</a></Callout>
...
<Callout>If you don't want to construct the transaction yourself, you can refer to the <a href="/wallet-client/lending#borrow">borrow feature of @naviprotocol/wallet-client</a></Callout>
...
<Callout>If you don't want to construct the transaction yourself, you can refer to the <a href="/wallet-client/lending#repay">repay feature of @naviprotocol/wallet-client</a></Callout>
