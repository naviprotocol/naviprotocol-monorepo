...
<Callout>
  For a more structured way to manage positions with automatic value calculations, EMode support, and overview statistics, see the <a href="/lending/position">Position Management</a> documentation.
</Callout>
