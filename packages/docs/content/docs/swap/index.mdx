...
<Callout>We also provide <a href="/wallet-client/swap">@naviprotocol/wallet-client</a>, which encapsulates the core functions of @naviprotocol/astros-aggregator-sdk and offers a simpler integration method.</Callout>
