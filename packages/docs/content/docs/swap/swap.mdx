...
<Callout>If you don't want to construct the transaction yourself, you can refer to the <a href="/wallet-client/swap#swap">swap feature of @naviprotocol/wallet-client</a></Callout>
